...
public:
    DXFParsePathAdaptor(void *easy_render_pointer, void (*v)(PrimitiveContainer *), void (*m)(PrimitiveContainer*, nlohmann::json));
    ...
    void GetBoundingBox(std::vector<std::vector<double_point_t>> path_stack, double_point_t *bbox_min, double_point_t *bbox_max);
    ...
    std::vector<std::vector<double_point_t>> Chainify(std::vector<double_line_t> line_stack, double tolorance);
    void Finish();
