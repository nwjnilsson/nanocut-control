...
std::string EasyPrimitive::Box::get_type_name() { return "box"; }
void        EasyPrimitive::Box::process_mouse(float mpos_x, float mpos_y)
{
  ...
  if (mpos_x > this->bottom_left.x &&
      mpos_x < (this->bottom_left.x + this->width) &&
      mpos_y < (this->bottom_left.y + this->height) &&
      mpos_y > this->bottom_left.y) {
...
void EasyPrimitive::Box::render_rectangle_with_radius(
...
void EasyPrimitive::Box::render()
{
  if (this->properties->visible == true) {
    ...
    glScalef(this->properties->scale,
    ...
    this->render_rectangle_with_radius(this->bottom_left.x,
                                       this->bottom_left.y + this->height,
                                       this->width,
                                       this->height,
                                       this->corner_radius);
    glPopMatrix();
...
void           EasyPrimitive::Box::destroy() { delete this->properties; }
