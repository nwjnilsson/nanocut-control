...
std::string EasyPrimitive::Circle::get_type_name() { return "circle"; }
...
void EasyPrimitive::Circle::render_arc(
...
void           EasyPrimitive::Circle::destroy() { delete this->properties; }
