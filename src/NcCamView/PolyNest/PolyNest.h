...
private:
  ...
  static ClipperLib::Path  rotatePolygon(const ClipperLib::Path& poly,
                                         double                  angle);
  ...
  const ClipperLib::Paths& getNfpCached(size_t stat_idx,
                                        double stat_angle,
                                        size_t orb_idx,
                                        double orb_angle);
...
public:
  ...
  int  placeAllUnplacedParts(std::atomic<float>* progress); // Returns number of
                                                            // parts that failed
                                                            // to place
};
