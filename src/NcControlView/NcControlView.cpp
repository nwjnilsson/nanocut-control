...
void NcControlView::preInit()
{
  ...
  if (parameters != NULL) {
    ...
    m_machine_parameters.machine_extents[0] = 1400.f;
    m_machine_parameters.machine_extents[1] = 1400.f;
    m_machine_parameters.machine_extents[2] = 60.f;
    m_machine_parameters.cutting_extents[0] = 50.f;
    m_machine_parameters.cutting_extents[1] = 50.f;
    m_machine_parameters.cutting_extents[2] = -50.f;
    m_machine_parameters.cutting_extents[3] = -50.f;
    m_machine_parameters.axis_scale[0] = 200 * 0.25f;
    m_machine_parameters.axis_scale[1] = 200 * 0.25f;
    m_machine_parameters.axis_scale[2] = 200 * 0.25f;
    m_machine_parameters.max_vel[0] = 1000.f;
    m_machine_parameters.max_vel[1] = 1000.f;
    m_machine_parameters.max_vel[2] = 250.f;
    m_machine_parameters.max_accel[0] = 800.0f;
    m_machine_parameters.max_accel[1] = 800.0f;
    m_machine_parameters.max_accel[2] = 200.0f;
    m_machine_parameters.junction_deviation = 0.005f;
    ...
    m_machine_parameters.floating_head_backlash = 10.f;
    m_machine_parameters.z_probe_feedrate = 100.f;
    ...
    m_machine_parameters.homing_feed = 400.f;
    m_machine_parameters.homing_seek = 800.f;
    m_machine_parameters.homing_debounce = 250.f;
    m_machine_parameters.homing_pull_off = 10.f;
    ...
    m_machine_parameters.precise_jog_units = 5.f;
  }
}
